...
#'
#' Computes the Kolmogorov--Smirnov test adapted to left truncation and the corresponding \eqn{p}-value.
#'
...
#' @param keep.boot Logical, default to FALSE. If TRUE, the test statistics evaluated
#' in the bootstrap resamples are included in the output.
...
#' * `stat.boot`: statistics computed from the bootstrap resamples. Included in the output
...
#'
#' Lago, A., Pardo-Fernández, J.C., and de Uña-Álvarez, J. (2026). A Kolmogorov--Smirnov-type test
